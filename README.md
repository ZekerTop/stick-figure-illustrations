...
把文章、文档、教程、PPT、社媒内容、开源项目说明和产品状态，转成以**中性火柴人**为默认主体的草图式解释插画。
...
这个 skill 适合把“文字里真正需要被看见的地方”转成草图概念，而不是平均给每个段落配图。
...
默认先给出 3-6 张候选图。短内容可以只有 1-2 张；课程、长文或轮播可以扩到 8-10 张，但每张都要说明用途。
