...
description: |
  ...
  用户没有特别指定人物形态时，必须默认生成中性火柴人：圆头、线条身体、简单四肢、黑色线稿、
  可品牌化的单色点缀；不要使用任何特定作者 IP、固定吉祥物、高识别度角色设定或可识别的第三方风格。
---
...
这不是某个角色 IP，也不是个人作者风格复刻。默认人物必须是匿名火柴人：圆头、线条身体、简单四肢、无品牌身份、无固定名字。除非用户明确要求“不要人物”“只要图标”“只要抽象图形”，否则生成图里应该以火柴人为主要视觉主体。
