...
默认追求表现力，不追求“字越少越好”。文字可以更丰富，但必须增强情绪、对比、节奏或记忆点；不要变成段落说明、满屏标注或 PPT 模板。
...
- 火柴人是什么情绪
- 主要元素
- 建议标注密度；以表现力为准，可以简洁，也可以更丰富，但不能让文字压过画面
- 优先级
...
- 大量留白
- 标注按内容需要决定；优先增强表现力，可以无文字、少量关键词，也可以在观点、教程、对比、流程场景中更丰富
